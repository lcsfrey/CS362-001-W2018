...
public class TimeTableTest {
	 ...
	 @Test
	  public void test01()  throws Throwable  {
		 ...
		 Appt appt = new Appt(startHour, startMinute, startDay-1, startMonth,
                startYear, "copy", "copy description");
		 listAppts.add(appt);
		 
		 appt = new Appt(-1, startMinute, startDay, startMonth,
                startYear, "invalid", "invalid description");
		 listAppts.add(appt);
	 ...
	 @Test
	  public void testReccuringApptRange()  throws Throwable  {
		...
		// assertEquals(3, apptRange.get(0).getSizeAppts()); 
		 ...
		 listAppts.get(2).setRecurrence(recurDays, 4, 2, 3);
		 apptRange = table.getApptRange(listAppts, firstDay, lastDay); 
	 }
