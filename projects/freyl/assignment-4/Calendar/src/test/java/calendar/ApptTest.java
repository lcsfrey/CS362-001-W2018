	...
	// assertions 
	 ...
	 @Ignore
		public void testValid() throws Throwable {
			 ...
			 //Construct a new Appointment object with the initial data	 
			 Appt valid_appt_1 = new Appt(startHour, startMinute, startDay, startMonth,
			                              startYear, val_appt, description);

			assertEquals(true, valid_appt_1.getValid());

			Appt valid_appt_2 = new Appt(startHour+23, startMinute, startDay, startMonth,
			                              startYear, val_appt, description);
			assertEquals(true, valid_appt_2.getValid());

			Appt valid_appt_3 = new Appt(startHour, startMinute+59, startDay, startMonth,
			                              startYear, val_appt, description);
			assertEquals(true, valid_appt_3.getValid());

			Appt valid_appt_4 = new Appt(startHour, startMinute, startDay+30, startMonth,
			                              startYear, val_appt, description);
			assertEquals(true, valid_appt_4.getValid());

			Appt valid_appt_5 = new Appt(startHour, startMinute, startDay, startMonth+11,
			                              startYear, val_appt, description);
			//assertEquals(true, valid_appt_5.getValid());
		}

		@Ignore @Test public void testInvalid() throws Throwable {
			 int startHour=0;
			 int startMinute=0;
			 int startDay=1;
			 int startMonth=1;
	 ...
	 @Ignore @Test
	  public void testToString()  throws Throwable  {
		 ...
		 Appt appt1 = new Appt(0, startMinute, startDay, startMonth,
                 startYear, title, description);
		 //assertEquals("\t1/15/2018 at 12:30am ,test set method, This is a test", appt1.toString());
		 
		 Appt appt2 = new Appt(12, startMinute, startDay, startMonth,
                 startYear, title, description);
		//assertEquals("\t1/15/2018 at 12:30pm ,test set method, This is a test", appt1.toString());
		 
		 Appt appt3 = new Appt(3, startMinute, startDay, startMonth,
                 startYear, title, description);
		//assertEquals("\t1/15/2018 at 3:30am ,test set method, This is a test", appt1.toString());
	 }
