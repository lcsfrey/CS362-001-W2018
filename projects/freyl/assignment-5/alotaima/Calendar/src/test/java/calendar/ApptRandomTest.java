...
public class ApptRandomTest {
    ...
    public static int RandomSelectRecur(Random random) {
        int[] RecurArray = new int[] { Appt.RECUR_BY_WEEKLY, Appt.RECUR_BY_MONTHLY,
                Appt.RECUR_BY_YEARLY, 4 };// The list of the of setting appointments
                                          // to recur Weekly, Monthly, or Yearly

        int n = random.nextInt(RecurArray.length);// get a random number between 0 (inclusive) and
                                                  // RecurArray.length (exclusive)
