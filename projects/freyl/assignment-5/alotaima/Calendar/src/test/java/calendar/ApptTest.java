...
public class ApptTest {
    ...
    public void testInvalid() throws Throwable {
        ...
        Appt invalid_appt_5 = new Appt(startHour, startMinute, startDay, startMonth - 1, startYear,
                val_appt, description);
        assertEquals(false, invalid_appt_5.getValid());

        Appt invalid_appt_6 = new Appt(startHour, startMinute, startDay, startMonth + 12, startYear,
                val_appt, description);
        assertEquals(false, invalid_appt_6.getValid());

        Appt invalid_appt_7 = new Appt(startHour, startMinute, startDay - 1, startMonth, startYear,
                val_appt, description);
        assertEquals(false, invalid_appt_5.getValid());

        Appt invalid_appt_8 = new Appt(startHour, startMinute, startDay + 31, startMonth, startYear,
                val_appt, description);
        assertEquals(false, invalid_appt_6.getValid());
    ...
    public void testInvalidSetMethods() throws Throwable {
        ...
        assertEquals(false, appt.getValid());
        /*
         * appt = new Appt(startHour, startMinute, startDay, startMonth, startYear,
         * title, description); appt.setStartHour(-1); assertEquals(false,
         * appt.getValid()); appt.setStartHour(0); assertEquals(true, appt.getValid());
         * appt.setStartHour(24); assertEquals(false, appt.getValid());
         */
    ...
    public void testToString() throws Throwable {
        ...
        Appt appt = new Appt(startHour, startMinute, startDay, startMonth, startYear, title,
                description);
        String appt_str = "\t1/15/2018 at 9:30pm ,test set method, This is a test\n";
        assertTrue(appt.toString().equals(appt_str));

        Appt appt1 = new Appt(0, startMinute, startDay, startMonth, startYear, title, description);
        appt_str = "\t1/15/2018 at 12:30am ,test set method, This is a test\n";
        assertTrue(appt1.toString().equals(appt_str));

        Appt appt2 = new Appt(12, startMinute, startDay, startMonth, startYear, title, description);
        appt_str = "\t1/15/2018 at 12:30pm ,test set method, This is a test\n";
        assertTrue(appt2.toString().equals(appt_str));

        Appt appt3 = new Appt(3, startMinute, startDay, startMonth, startYear, title, description);
        appt_str = "\t1/15/2018 at 3:30am ,test set method, This is a test\n";
        assertTrue(appt3.toString().equals(appt_str));
    }
    ...
    public void testInvalidToString() throws Throwable {
        ...
        // Construct an invalid appointment
        Appt appt = new Appt(startHour, startMinute, startDay, startMonth, startYear, title,
                description);
