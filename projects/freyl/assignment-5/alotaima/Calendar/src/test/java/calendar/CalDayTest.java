...
public class CalDayTest {
    ...
    public void testAddAppt() throws Throwable {
        ...
        Appt appt1 = new Appt(startHour - 1, startMinute, startDay, startMonth, startYear, title,
                description);
        ...
        Appt appt3 = new Appt(startHour, startMinute + 1, startDay, startMonth, startYear, title,
                description);
        calday.addAppt(appt3);

        Appt invalid_appt = new Appt(startHour, -1, startDay, startMonth, startYear, title,
                description);
